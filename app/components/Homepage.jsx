...
export default function HomePage({ chatChannelId }) {
  ...
  return (
    <>
      ...
      <SignedOut>
        <Header/>
        <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white px-6 text-center relative overflow-hidden">
          {/* Hero Section */}
      ...
      <SignedIn>
        <PDFRAG user={user} chatChannelId={chatChannelId} />
      </SignedIn>
    </>
  );
}
